...
namespace TestApp
{
    ...
    public:
        ...
        virtual void callback_testHelloTwo(tars::Int32 ret,  const std::string& sRsp)
        { throw std::runtime_error("callback_testHelloTwo() override incorrect."); }
        virtual void callback_testHelloTwo_exception(tars::Int32 ret)
        { throw std::runtime_error("callback_testHelloTwo_exception() override incorrect."); }
        ...
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            switch(r.first - __Hello_all)
            {
                ...
                case 2:
                {
                    if (msg->response->iRet != tars::TARSSERVERSUCCESS)
                    {
                        callback_testHelloTwo_exception(msg->response->iRet);
                    ...
                    callback_testHelloTwo(_ret, sRsp);
        ...
        int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            switch(r.first - __Hello_all)
            {
                ...
                case 2:
                {
                    ...
                    {
                        callback_testHelloTwo_exception(tars::TARSCLIENTDECODEERR);
    ...
    public:
        ...
        tars::Int32 testHelloTwo(const std::string & sReq,std::string &sRsp,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(sReq, 1);
            _os.write(sRsp, 2);
            std::map<string, string> _mStatus;
            shared_ptr<tars::ResponsePacket> rep = tars_invoke(tars::TARSNORMAL,"testHelloTwo", _os, context, _mStatus);
            if(pResponseContext)
            {
                pResponseContext->swap(rep->context);
            }
        ...
        void async_testHelloTwo(HelloPrxCallbackPtr callback,const std::string &sReq,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(sReq, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testHelloTwo", _os, context, _mStatus, callback);
        }
        
        void coro_testHelloTwo(HelloCoroPrxCallbackPtr callback,const std::string &sReq,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(sReq, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testHelloTwo", _os, context, _mStatus, callback, true);
        }
    ...
    public:
        ...
        virtual tars::Int32 testHelloTwo(const std::string & sReq,std::string &sRsp,tars::TarsCurrentPtr current) = 0;
        static void async_response_testHelloTwo(tars::TarsCurrentPtr current, tars::Int32 _ret, const std::string &sRsp)
        {
            if (current->getRequestVersion() == TUPVERSION )
            {
                UniAttribute<tars::BufferWriterVector, tars::BufferReader>  tarsAttr;
    ...
    public:
        int onDispatch(tars::TarsCurrentPtr _current, vector<char> &_sResponseBuffer)
        {
            ...
            pair<string*, string*> r = equal_range(__TestApp__Hello_all, __TestApp__Hello_all+3, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __TestApp__Hello_all)
            {
                ...
                case 2:
                {
                    ...
                    tars::Int32 _ret = testHelloTwo(sReq,sRsp, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
